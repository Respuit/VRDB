...
opinions:
    ...
    - steamVR: 1
      ...
      text: |
          CachyOS 6.18.2-3
          Works perfectly in SteamVR through ALVR. 
          Stuck overlays when run through WiVRn.
      date: 2025-12-22
      user: LostThoughtGit
    ...
    - steamVR: 1
      ...
      device: Quest 2
      text: |
          Stuck overlays on loading screens using WiVRn, so I switched to ALVR and it fixed the problem.
      date: 2026-01-10
      user: Jaimete35
---
