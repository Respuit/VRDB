...
opinions:
    ...
    - steamVR: 1
      ...
      text: |
          SteamVR: Works perfectly, except for trying to access either Secret Shop or Robot Repair, which requires launching manually to play.
          Monado and OpenComposite: Controller angle is off, as well as requires editing the JSON file for your controller bindings (in my case, it's `~/.local/share/Steam/steamapps/common/The Lab/TheLab/win64/TheLab_Data/StreamingAssets/SteamVR/bindings_rift.json`) and tweak the teleport binding. Just like running with SteamVR, still can't access either Secret Shop or Robot Repair.
      date: 2026-01-11
      user: ubuntuxp
---
