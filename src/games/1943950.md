...
opinions:
    ...
    - steamVR: 5
      ...
      device: Meta Quest 3
      text: |
          The game HAD a hidden VR mode that worked with WiVRn, ALVR and Steam Link. However, it was removed as of 1.0 and the developer didn't say if it will ever return. Will update this report if it does.
          Gameplay when it still worked: https://youtu.be/ngMGnHCCbq8
          Follow my Steam Curator with links back to VROnLinux DB: https://store.steampowered.com/curator/45753882-VR-Linux/
      date: 2025-11-10
      user: Patola
---
