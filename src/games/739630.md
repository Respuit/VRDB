...
opinions:
    ...
    - steamVR: 0
      ...
      device: Meta Quest 3
      text: |
          Set the launch options to "SteamDeck=1 %command%" for voice recognition to work. There is sometimes lag inside the van and I once spawned below the floor. But the game is still in a playable state with good quality.
      date: 2026-01-11
      user: MaxTGamer
---
