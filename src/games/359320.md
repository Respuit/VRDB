...
opinions:
    ...
    - steamVR: 0
      ...
      device: Quest 3
      text: |
          RTX3090, proprietary drivers. GE Proton 10.17 is the only version I've found to work well with VR.
          Wivrn works great until you land. Currently crashes at the main menu. Looks and performs better than ALVR.
          ALVR works fairly consistently, uncommon to crash or bug out. Color banding especially noticeable during loading screen.
          No extra launch options etc.
      date: 2025-10-14
      user: luthis1124
