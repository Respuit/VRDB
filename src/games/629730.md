...
opinions:
    ...
    - steamVR: 1
      ...
      text: |
          Works even when modded, HOWEVER on WiVRn/Monado (because of xrizer bug, but it's being worked on currently) controller input has some issues, and buttons don't register correctly. Scrolling thru menus isn't working, and buttons are "sticky".
      date: 2025-11-30
      user: sezamn1
---
