...
opinions:
    ...
    - steamVR: 4
      ...
      device: Quest Pro
      text: |
          The application "worked" but it was only shown on the left display, also heavily stuttering.
          I have not tried tinkering jet, maybe it works better with another proton version or additional commands
      date: 2025-12-13
      user: moku89
---
