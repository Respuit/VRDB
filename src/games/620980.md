...
opinions:
    ...
    - steamVR: 0
      ...
      device: Quest 2
      text: |
          newest version doesn't work properly with WayVR (wlx-overlay-s), very dark and no ui.But works otherwise. Legacy version 1.40.8 works well with OXR_PARALLEL_VIEWS=0 set, as mentioned in this WiVRn issue: https://github.com/WiVRn/WiVRn/issues/733 . Without it, the game flickers
      date: 2026-01-12
      user: Johto65
    ...
    - steamVR: 0
      ...
      text: |
          Playing version 1.40.8 with BSManager due to mod compatibility.
          Due to a regression in Monado, `OXR_PARALLEL_VIEWS=0` needs to be set in the environment variables.
          See WiVRn issue with details: https://github.com/WiVRn/WiVRn/issues/733
      date: 2026-01-12
      user: RubberDuckShobe
---
